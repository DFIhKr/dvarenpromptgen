...
serve(async (req) => {
  ...
  try {
    ...
    const defaultModelMap: Record<string, string> = { groq: "llama-3.3-70b-versatile", openrouter: "meta-llama/llama-3.3-70b-instruct:free", gemini: "gemini-2.5-flash", nvidia: "stepfun-ai/step-3.5-flash", '9router': "claude-sonnet-4.6" };
